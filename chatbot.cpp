...
SimpleChatbot::SimpleChatbot() {
    responses = {
                 ...
                 {std::regex("what is vaccicare|what's vaccicare|vaccicare|about", std::regex_constants::icase), "You're welcome! Hope I was helpful!"},
...
std::string SimpleChatbot::getResponse(const std::string& userInput) {
